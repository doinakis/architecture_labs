...
| BENCHMARK          | L1 ISIZE | L1 DSIZE | ASSOC1 | ASSOC2 | L2 SIZE | ASSOC | CPI      | CACHE LIZE SIZE | COST    |
| :---               |:---:     | :---:    | :---:  | :---:  | :---:   | :---: | :--:     | :--------------:| ----:   |
| SPECBZIP(DEFAULT)  | 32kB     | 64kB     |  2     |   2    |  2MB    |   8   | 1,67965  |       64        | 1655,01 |
| SPECBZIP(L2)       | 32kB     | 64kB     |  2     |   2    |  4MB    |   1   | 1,67965  |       64        | 1628,15 |
| SPECBZIP(CLS)      | 32kB     | 16kB     |  2     |   1    |  2MB    |   8   | 1,852581 |       32        | 1380,29 |
| SPECBZIP(Dcache)   | 32kB     | 16kB     |  2     |   4    |  4MB    |   8   | 1,70806  |       256       | 3750,89 |
| SPECBZIP(Icache)   | 16kB     | 64kB     |  1     |   2    |  4MB    |   8   | 1,65004  |       256       | 3870,99 |
| SPECHMMER(DEFAULT) | 32kB     | 64kB     |  2     |   2    |  2MB    |   8   | 1,187917 |       64        | 1170,49 |
| SPECHMMER(L2)      | 32kB     | 64kB     |  2     |   2    |  512kB  |   1   | 1,188545 |       64        | 1159,25 |
| SPECHMMER(CLS)     | 32kB     | 64kB     |  2     |   2    |  2MB    |   8   | 1,196843 |       32        | 892,04  |
| SPECHMMER(Dcache)  | 32kB     | 16kB     |  2     |   4    |  512kB  |   4   | 1,180538 |       256       | 2579,50 |
| SPECHMMER(Icache)  | 16kB     | 64kB     |  2     |   2    |  512kB  |   4   | 1,180635 |       256       | 2760,74 |
| SPECLBM(DEFAULT)   | 32kB     | 64kB     |  2     |   2    |  2MB    |   8   | 3,493415 |       64        | 3442,17 |
| SPECLIBM(L2)       | 32kB     | 64kB     |  2     |   2    |  1MB    |   1   | 3,495444 |       64        | 3412,71 |
...
| SPECSJENG(Dcache)  | 32kB     | 16kB     |  2     |   2    |  4MB    |   2   | 5,172786 |       256       | 11293,91|
| SPECSJENG(Icache)  | 16kB     | 64kB     |  1     |   2    |  4MB    |   2   | 5,173158 |       256       | 12105,18| 

Ο λόγος για τον οποίο τα costs για τα dcache και icache benchmarks είναι αρκετά μεγαλύτερο από τα L2 και CLS είναι γιατί είχαμε κάνει άπληστη επιλογή των L2 και cache line size χωρίς να σκεφτούμε το κόστος που θα επέφεραν αυτές.Μια πιο σωστή προσέγγιση θα ήταν να έχουμε κάνει τη συνάρτηση κόστους από την αρχή, να βρούμε τα βέλτιστα με βάση τη συνάρτηση και μετά με αυτά να συνεχίσουμε στην εκτέλεση των υπόλοιπων. Η συνάρτηση είναι φτιαγμένη έτσι ώστε να μεγαλώνει πολύ το κόστος απόδοσης, αν οι αλλαγές δεν επιφέρουν αισθητή αλλαγή στο CPΙ.
#### Σχόλια 
